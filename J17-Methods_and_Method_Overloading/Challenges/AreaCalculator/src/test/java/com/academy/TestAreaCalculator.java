...
public class TestAreaCalculator {
    ...
    void circleArea() {
        ...
        Assertions.assertEquals(0.0, AreaCalculator.area(0d));
    }
    ...
    void rectangleArea() {
        ...
        Assertions.assertEquals(0.0, AreaCalculator.area(0d, 23.58d));
        Assertions.assertEquals(0.0, AreaCalculator.area(56.7d, 0d));
        Assertions.assertEquals(0.0, AreaCalculator.area(0d, 0d));
    }
}
